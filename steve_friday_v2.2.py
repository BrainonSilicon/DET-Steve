...
def offer_choice(screen, choice1,): #TODO: add choice2 back in before ):    print('{} or {}?'.format(choice1, choice2))
    screen.askQuestion(choice1) #TODO add this back in , choice2)

# this is steve detecting a person and what starts the interaction 
def person(image_path):
...
def bits_together(screen, right_question, right_answer): # TODO took out left question and left answer 
    ...
    #TODO this is what it was before offer_choice(screen, left_question, right_question)
    offer_choice(screen, right_question)
...
def main():
    ...
    #this should reset the servo motors
    #TODO this threw an error so I commented it out my_servo.angle = 0 
    # LCD Prompt 1
    bits_together(steveScreen, right_answer, "hello")
    time.sleep(2)
    print ("DONE!")
