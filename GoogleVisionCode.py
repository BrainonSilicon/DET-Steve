...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "..." #PUT IT IN THE RIGHT PLACE FUCK IT ALL
...
def ocr_handwriting(image):
    ...
    arm_up_string = "hi pinky"    #what string triggers 'flag up'?
    arm_down_string = "goodnight pinky"  #what string triggers 'flag down'?
...
def image_labeling(image):
    ...
    sound1 = "/home/pi/DET2019_Class5/dog2.wav" #excited beep boop
    sound2 = "/home/pi/DET2019_Class5/cat.wav" #scared beep boop 
...
def face_distinction(image):
    ...
    sound_file = "/home/pi/DET2019_Class5/hello2.wav" #change this
